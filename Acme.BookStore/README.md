...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f06d74b4-5985-4d46-b2ff-f2d0df8e5b46
```

> `f06d74b4-5985-4d46-b2ff-f2d0df8e5b46` is the password of the certificate, you can change it to any password you want.
