...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20250522115133_Add_Booking_Entities")]
    partial class Add_Booking_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Books.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Hotel.Rooms.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Hotel.Rooms.Guest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Hotel.Rooms.Manager", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Hotel.Rooms.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Hotel.Rooms.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Hotel.Rooms.Booking", b =>
                {
                    b.HasOne("Acme.Hotel.Rooms.Room", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("Acme.BookStore.Books.Author", null)
                        .WithMany()
